...
public class Frm_cadastroQuarto extends javax.swing.JFrame {
    ...
    private void preencherTabela() {
        ...
        try {
            QuartoDTO quartos = (QuartoDTO) controleQuarto.read();
            IteratorQuartoDTO iterator = new IteratorQuartoDTO(quartos.getAllQuartos());

            while (iterator.hasnext()) {
                QuartoDTO atual = (QuartoDTO) iterator.next();
                String[] dados = new String[4];
                dados[0] = atual.getId() + "";
                dados[1] = atual.getAccommodations() + "";
                dados[2] = atual.getDaily() + "";
                dados[3] = atual.getStatus();
                modelo.addRow(dados);
            }
    ...
    private void initComponents() {
        ...
        btNovo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ifpb/ads/icones/novo.png"))); // NOI18N
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        // TODO add your handling code here:
        ArrayList<ExtraDTO> extrasQuarto = new ArrayList<ExtraDTO>();
        ...
        for (int i = 0; i < tbl_extras.getRowCount(); i++) {
            ...
            ExtraDTO extraTabela = new ExtraDTO();
            extraTabela.setId(id);
            extraTabela.setExtra(extra);
        ...
        try {
            ...
            quarto.setListExtras(extrasQuarto);

            if (!campoAcomodacoes.getText().equals("") && !campoDiaria.getText().equals("")) {
                if (controleQuarto.save(quarto)) {
