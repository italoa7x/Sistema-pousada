...
import ifpb.ads.view.factoryControl.FactoryReserva;
...
public class Frm_reserva extends javax.swing.JFrame {
     ...
     */
    private ITfactory fabricaQuarto, fabricaReserva, fabricaHospede;
    private StrategyCrud controleQuartos, controleReserva, controleHospede;

    public Frm_reserva() {
        initComponents();
        // ÁREA DE CRIAÇÃO DAS FÁBRICAS
        fabricaQuarto = new FactoryQuarto();
        fabricaReserva = new FactoryReserva();
        fabricaHospede = new FactoryHospede();
        // ÁREA DA CRIAÇÃO DOS CONTROLERS
        controleQuartos = (Controler_Quarto) fabricaQuarto.gerar("control");
        controleReserva = (Controler_Reserva) fabricaReserva.gerar("control");
